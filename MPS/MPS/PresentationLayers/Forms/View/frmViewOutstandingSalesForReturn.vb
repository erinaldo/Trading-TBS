Public Class frmViewOutstandingSalesForReturn
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "ArrivalNettoAfterSales", "Netto 2 Beli", 100, UI.usDefGrid.gReal2Num)
    ...
    Private Sub prvQuery()
        ...
        pgMain.Value = 30
        Try
            grdMain.DataSource = BL.Sales.ListDataOutstandingReturn(pubCS.CompanyID, pubCS.ProgramID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, pubBPID)
...
#Region "Form Handle"
    ...
    Private Sub frmViewOutstandingSalesForReturn_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmViewOutstandingSalesForReturn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
