...
Public Class frmMstBusinessPartnerHistory

    Public Property pubBPID As Integer = 0
    ...
    Private Sub prvFillCombo()
        UI.usForm.FillComboBox(cboTransaction, VO.BusinessPartner.DataHistoryFilter, "ID", "Name")
    End Sub
    ...
    Private Sub prvQuery()
        ...
        Try
            grdMain.DataSource = BL.History.ListDataHistoryItem(dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboTransaction.SelectedValue, pubBPID)
            prvSumGrid()
...
#Region "Form Handle"
    ...
    Private Sub frmMstBusinessPartnerHistory_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstBusinessPartnerHistory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
