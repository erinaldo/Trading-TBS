Public Class frmMstSalesDiscount
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "Amount", "Harga", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "StartDate", "Dari Tanggal", 100, UI.usDefGrid.gFullDate)
        UI.usForm.SetGrid(grdView, "EndDate", "Sampai Tanggal", 100, UI.usDefGrid.gFullDate)
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.SalesDiscount.ListData()
    ...
    Private Sub prvGet()
        ...
        If grdView.GetRowCellValue(intPos, "StatusInfo") = "IN-ACTIVE" Then
            UI.usForm.frmMessageBox("Tidak dapat pilih diskon penjualan " & grdView.GetRowCellValue(intPos, "Name") & ". Dikarenakan diskon penjualan tersebut sudah tidak aktif")
            Exit Sub
        Else
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmMstSalesDiscountDet
        With frmDetail
            .pubIsNew = True
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.SalesDiscount.DeleteData(grdView.GetRowCellValue(intPos, "ID"))
    ...
    Private Sub prvUserAccess()
        With ToolBar.Buttons
            .Item(cNew).Visible = BL.UserAccess.IsCanAccess(MPSLib.UI.usUserApp.UserID, MPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterSalesDiscount, VO.Access.Values.NewAccess)
            .Item(cDelete).Visible = BL.UserAccess.IsCanAccess(MPSLib.UI.usUserApp.UserID, MPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterSalesDiscount, VO.Access.Values.DeleteAccess)
        End With
    End Sub

#Region "Form Handle"

    Private Sub frmMstSalesDiscount_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Close this form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstSalesDiscount_Load(sender As Object, e As EventArgs) Handles MyBase.Load
