        ...
        Public Shared Function ListData(ByVal dtmDateFrom As DateTime, ByVal dtmDateTo As DateTime, ByVal intIDStatus As Integer) As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                   ...
                   "WHERE  " & vbNewLine & _
                   "    A.JournalDate>=@DateFrom AND A.JournalDate<=@DateTo " & vbNewLine & _
            ...
            With sqlcmdExecute
                If bolNew Then
                    .CommandText = _
                       ...
                       "    (CompanyID, ID, JournalDate, ReferencesID, TotalAmount, IsAutoGenerate, Remarks, IDStatus, CreatedBy, CreatedDate,   " & vbNewLine & _
                       "     LogBy, LogDate)   " & vbNewLine & _
                       "VALUES " & vbNewLine & _
                       "    (@CompanyID, @ID, @JournalDate, @ReferencesID, @TotalAmount, @IsAutoGenerate, @Remarks, @IDStatus, @LogBy, GETDATE(),   " & vbNewLine & _
...
#Region "Detail"
        ...
        Public Shared Sub SaveDataDetail(ByVal clsData As VO.JournalDet)
            ...
            With sqlcmdExecute
                ...
                .Parameters.Add("@ID", SqlDbType.VarChar, 20).Value = clsData.ID
                .Parameters.Add("@JournalID", SqlDbType.VarChar, 20).Value = clsData.JournalID
            ...
            Try
                ...
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        ...
                        "WHERE  " & vbNewLine & _
                        "   LEFT(JournalID,17)=@JournalID " & vbNewLine
        ...
        Public Shared Function GetMaxIDStatus(ByVal strJournalID As String) As Integer
            ...
            Try
                ...
                With sqlcmdExecute
                    ...
                    .Parameters.Add("@JournalID", SqlDbType.VarChar, 17).Value = strJournalID
