...
#Region "Detail"
        ...
        Public Shared Function ListDataDetailWithOutstanding(ByVal strARID As String, ByVal intBPID As Integer) As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                   "SELECT " & vbNewLine & _
                   "     CAST(1 AS BIT) AS Pick, A.ID, A.ARID, A.SalesID, A.Amount, TS.TotalPrice-TS.TotalReturn-TS.TotalPayment+A.Amount AS MaxAmount " & vbNewLine & _
                ...
                .CommandText += _
                    ...
                    "SELECT " & vbNewLine & _
                    "     CAST(0 AS BIT) AS Pick, CAST(NEWID() AS VARCHAR(40)) AS ID, CAST('' AS VARCHAR(20)) AS ARID, TS.ID AS SalesID, CAST(0 AS DECIMAL(18,2)) Amount, TS.TotalPrice-TS.TotalReturn-TS.TotalPayment AS MaxAmount " & vbNewLine & _
        ...
        Public Shared Function ListDataDetailOutstanding(ByVal intBPID As Integer) As DataTable
            ...
            With sqlcmdExecute
                .CommandText = _
                   ...
                   "    TS.BPID=@BPID" & vbNewLine & _
                   "    AND TS.IsDeleted=0 " & vbNewLine & _
                   "    AND TS.TotalPrice-TS.TotalReturn-TS.TotalPayment>0 " & vbNewLine
